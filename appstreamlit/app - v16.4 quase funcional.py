...
#        <small>Supermercado mais próximo: {dist_sup:.2f}km<br>Escola mais próxima: {dist_sch:.2f}km</small><br><br>
...
#
        ...
        #        continue  # Pula imóvel com Lat/Lon inválido
else:
